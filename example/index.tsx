...
const DemoUI = () => {
	return (
		<div className="demo-content">
			...
			<TextInput errorText="Failed name" icon="icon-window-box" />
			<Avatar
				size="lg"
				placeholder="tung le"
			...
			/>
			<Slider showTooltipValue total={100} defaultValue={30} />
			<Tab>
				<Tab.Item title="tab 1">Hahaha 1</Tab.Item>
				<Tab.Item title="tab 2">hahah 2</Tab.Item>
				<Tab.Item title="tab 133" />
			</Tab>
		</div>
	);
};
